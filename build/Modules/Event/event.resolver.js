...
const event_type_1 = require("./type/event.type");
const event_input_1 = require("./type/event.input");
const event_model_1 = require("../../models/event.model");
const ObjectIdScalars_1 = require("../../Scalars/ObjectIdScalars");
let EventResolver = class EventResolver {
    async createEvent(input) {
        const create = await event_model_1.EventCollection.create(input);
        const result = {
            title: create.title,
...
__decorate([
    type_graphql_1.Mutation(() => event_type_1.EventPayload),
